function [ bu,bd,c ] = generate_boundary1( F,m )
...
%------------------------------------------------------------------------
switch F
%     case {'F1','F2','F3','F6'}   %ZDT系列   %%%% JC新添加的，区间准确与否有待再检查，参考网址 https://blog.csdn.net/qq_40456829/article/details/92790331#1%EF%BC%89ZDT1
%         bu=ones(1,c);
%         bd=zeros(1,c);    
...
%         bu=ones(1,c);
%         bd=zeros(1,c);
%     case {'F7','F8','F9','F10','F11','F12','F13'}      %DTLZ系列
%         bu=ones(1,c);
%         bd=zeros(1,c);
      case {'F1','F2','F3'}          %ZDT1、ZDT2、ZDT3      
          c=30;
          bu=ones(1,c);
          bd=zeros(1,c);     
...
%           bd=zeros(1,c);   
      ...
      case {'F8','F9','F10','F11','F12'}     %DTLZ2_m、 DTLZ3_m、DTLZ4_m、DTLZ5_m、DTLZ6_m
          c=m+9;
          bu=ones(1,c);
          bd=zeros(1,c);
      ...
      case 'F13'    %DTLZ7_m
       ...
       case {'F14','F15','F16','F17','F18','F19','F20','F21'}   %WFG1_m、WFG2_m、WFG3_m、WFG4_m、WFG5_m、WFG6_m、WFG7_m、WFG8_m
          c = m+9;
          bd=zeros(1,c);       
          bu=2:2:2*c;
